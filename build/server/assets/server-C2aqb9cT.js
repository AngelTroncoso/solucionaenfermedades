import { n as createMiddleware } from "./createStart-CmdQdnZF.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DctEDtbM.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-sQJgLvxV.js"),
		import("./start-BRsoFZwH.js"),
		import("./empty-plugin-adapters-DFHTEB3e.js")
	]);
	return {
		routerEntry,
		startEntry,
